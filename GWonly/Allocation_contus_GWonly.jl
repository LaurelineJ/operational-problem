...
"""
function initallocationcontusmac(m::Model)
    ...
    demandirrigation = readdlm("Dropbox/POSTDOC/AW-julia/operational-problem/data/gw_irr_2010.txt")
    demandurban = readdlm("Dropbox/POSTDOC/AW-julia/operational-problem/data/gw_urban_2010.txt")
    demandmining = readdlm("Dropbox/POSTDOC/AW-julia/operational-problem/data/gw_mining_2010.txt")
    allocation[:waterdemand] = repeat(demandurban[v,2]+demandmining[v,2]+demandirrigation[v,2],outer=[1,m.indices_counts[:time]]);

    temp = readdlm("Dropbox/POSTDOC/AW-julia/operational-problem/data/piezohead0.txt")
